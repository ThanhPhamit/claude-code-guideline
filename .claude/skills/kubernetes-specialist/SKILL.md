...
description: "Use when deploying or managing Kubernetes workloads on EKS or self-managed clusters. Invoke for deployment manifests, Helm charts, RBAC, NetworkPolicies, storage (EBS/EFS CSI), ALB Ingress Controller, ECR integration, debugging, or GitOps setup."
metadata:
  domain: infrastructure
  triggers: Kubernetes, K8s, kubectl, Helm, EKS, container orchestration, pod deployment, RBAC, NetworkPolicy, Ingress, ALB Ingress Controller, StatefulSet, Operator, ArgoCD, Flux, GitOps, Istio, service mesh, EBS CSI, EFS CSI
  role: specialist
